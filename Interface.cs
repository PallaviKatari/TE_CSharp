...
/// <summary>
/// interface - abstraction - information hiding - security 
/// interface - keyword interface - abstract methods and properties, cannot contain variables
/// Multiple inheritance(not supported) -> substituted by the interfaces concept
/// </summary>
namespace TE_CSharp
{
    /// <summary>
